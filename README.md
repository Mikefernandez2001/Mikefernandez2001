...
<body>
	...
	<div class="balloons text-center" id="b5">
    	<h4 style="color:#8377E4;">Dude</h4>
    </div>
    <div class="balloons text-center" id="b6">
    	<h4 style="color:#99C96A;">Friend</h4>
    </div>
    <div class="balloons text-center" id="b7">
    	<h4 style="color:#20CFB4;">self</h4>
    </div>
	...
	<div class="container">
		...
		<div class="row message">
			<div class="col-md-12">
				...
				<p>..and travelling daily to Japan :)</p>
				<p>I hope</p>
				<p>you'll find...</p>
